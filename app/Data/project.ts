...
export const projects: Project[] = [
    ...
    {
        title:"MetricAtlas",
        description:"An interactive dashboard to compare countries across seven socio-economic factors with dynamic charts, real-time data, and smart filters.",
    ...
    {
        title:"KisanSetu",
        description:"KisanSetu - A platform that connects farmers directly with buyers, helping them sell produce at fair prices while reducing middlemen and ensuring transparency in the supply chain.",
    ...
    },
    {
        ...
        description:"A front-end clone built to understand payment gateway UI and component structure. (Learning project)",
    ...
    {
        title:"To-do List",
        description:"A simple task manager app to add, edit, and delete daily tasks while learning CRUD concepts.(Learning project)",
    ...
    {
        title:"Weather App",
        description:"A weather forecasting app that shows real-time temperature and conditions for any city using a public weather API.(Learning project)",
